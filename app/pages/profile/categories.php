<?php if($action == 'add'):?>
	...
	<div class="col-md-6 mx-auto">
	  <form method="post" enctype="multipart/form-data">
	    ...
	    <a href="<?=ROOT?>/profile/categories">
...
<?php else:?>
	...
	<h4>
		Categories 
		<a href="<?=ROOT?>/profile/categories/add">
	...
	<table class="table">
		...
		<?php if(!empty($rows)):?>
			...
			<tr>
				...
				<td>
					<a href="<?=ROOT?>/profile/categories/edit/<?=$row['id']?>">
						<button class="btn btn-warning text-white btn-sm"><i class="bi bi-pencil-square"></i></button>
					</a>
					<a href="<?=ROOT?>/profile/categories/delete/<?=$row['id']?>">
