...
<?php else:?>
	...
	<table class="table">
		...
		<?php  
			...
			$query = "select * from posts where user_id = '$u_id' order by id desc limit $limit offset $offset";
			$rows = query($query);
		?>
