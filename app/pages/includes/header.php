    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
          ...
          <img class="bi me-2" src="<?=ROOT?>/assets/images/logo1.jpg"  width="60" height="52" style="object-fit:cover;">
        </a>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <?php if(!logged_in()):?><li><a href="<?=ROOT?>/login" class="nav-link px-2  <?=$url[0] =='search' ? 'link-primary':'link-dark'?>">Login/SignUp</a></li>
          <?php endif;?>
        </ul>
        ...
        <div class="dropdown text-end">
          ...
          <ul class="dropdown-menu text-small">
            ...
            <?php if(!is_admin()):?><li><a class="dropdown-item" href="<?=ROOT?>/profile">Profile</a></li>
            <?php endif;?>
            <?php if(is_admin()):?><li><a class="dropdown-item" href="<?=ROOT?>/admin">Admin</a></li>
            <?php endif;?>
